(function($) {
     ...
     */
    var nvestbankextension = function() {
        this.version = "1.5";
        this.author = "pixiefy";
        this.$body = $('body');
        this.defaults = {
     ...
     */
    nvestbankextension.prototype.config = function(options) {
     ...
     * @description Initialize Pages Loader
     */
    nvestbankextension.prototype.initLoader = function() {
        
        $(window).on('load', function() {
            
            // add class to body
            $.nvestbankextension.bodyClassInit();

            // group of functions
            $.nvestbankextension.funcInit();

            // destroy sticky_in_parent
            $.nvestbankextension.destroyStick();
     ...
     * @description Initialize Pages Loader
     */
    nvestbankextension.prototype.destroyStick = function() {
     ...
     * @description Initialize Pages Loader
     */
    nvestbankextension.prototype.initResize = function() {
     ...
     * @description Initialize Pages Loader
     */
    nvestbankextension.prototype.initReady = function() {
        $(document).ready(function() {
            
            // group of functions
            $.nvestbankextension.initWow();
            $.nvestbankextension.initMenuScroll();
            $.nvestbankextension.initDocs();

            // destroy sticky_in_parent
            $.nvestbankextension.destroyStick();

            // hover parallax
            $.nvestbankextension.initMouseHoverParallax();

            // Dynamic Contact Form init
            $.nvestbankextension.initCForm();

            // Dynamic Ajax Mailchimp subscription form
            $.nvestbankextension.initAjaxChimp();
     ...
     */
    nvestbankextension.prototype.funcInit = function() {
     ...
     */
    nvestbankextension.prototype.bodyClassInit = function() {
     ...
     */
    nvestbankextension.prototype.setBannerThumbnail = function() {
     ...
     */
    nvestbankextension.prototype.setBannerMargin = function() {
     ...
     */
    nvestbankextension.prototype.stEqualHeight = function($item, $target) {
     ...
     */
    nvestbankextension.prototype.initWow = function() {
     ...
     */
    nvestbankextension.prototype.initCountDown = function() {
     ...
     * @description Set dynamic banner margin top
     */
    nvestbankextension.prototype.initMap = function() {
     ...
     */
    nvestbankextension.prototype.initGoogleMap = function() {

        if ( $('#st_google_map').length && !window.google ) {
            $.getScript("https://maps.googleapis.com/maps/api/js?key="+ this.defaults.gmapApiKey +"&callback=nvestbankextension.initMap");
        }
     ...
     */
    nvestbankextension.prototype.initResponsiveMenu = function(context) {
     ...
     */
    nvestbankextension.prototype.initMenuScroll = function() {
     ...
     */
    nvestbankextension.prototype.initMaginificVideo = function(context) {
     ...
     * @description init magnific popup video
     */
    nvestbankextension.prototype.initMouseHoverParallax = function() {
     ...
     */
    nvestbankextension.prototype.initAjaxChimp = function() {
    ...
    nvestbankextension.prototype.validateEmail = function(email) {
        var re = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
        return re.test(String(email).toLowerCase());
    }

    nvestbankextension.prototype.formError = function(element) {
     ...
     */
    nvestbankextension.prototype.initCForm = function() {
        ...
        $( ".st-contact-form-init" ).on( "submit", function( e ) {
            ...
            if(email.val().length <= 6 || $.nvestbankextension.validateEmail( email.val() ) == false || email.val().indexOf('@') == '-1'){
                var error = true;
                ...
                success: function( response ) {
                    if ( response ) {
                        ...
                        if( data.email_success !== 'undefined' ) {
                            ...
                            $.nvestbankextension.formError( $info );
                            console.log( "Error" );
                        }
                    } else {
                        $.nvestbankextension.formError( $info );
     ...
     */
    nvestbankextension.prototype.initCounter = function() {
     ...
     */
    nvestbankextension.prototype.initGeneral = function(context) {
     ...
     * @description general event and functionality js initial
     */
    nvestbankextension.prototype.initStickyMenu = function() {
     ...
     */
    nvestbankextension.prototype.initDocs = function(context) {
     ...
     * @description initial
     */
    nvestbankextension.prototype.init = function() {
    ...
    $.nvestbankextension = new nvestbankextension();
    $.nvestbankextension.Constructor = nvestbankextension;
    window.nvestbankextension = $.nvestbankextension;
